...
# from .serializers import CoursePageDetailSerializer,CoursePageSerializer
...
#             'retrieve': CoursePageDetailSerializer,
...
#         return CoursePage.objects.live().exact_type(CoursePage).filter(locale=locale)
...
#             queryset = CoursePage.objects.live().exact_type(CoursePage).filter(locale=locale)
